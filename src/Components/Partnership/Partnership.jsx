...
const PartnershipSection = () => {
  const partnersLoop = useMemo(
    () => partnerships.concat(partnerships, partnerships, partnerships),
    []
  );
            ...
            <div className="row row-cols-lg-2 row-cols-1 align-items-center px-5 position-relative z-2">
              <div className="col">
                <div className="d-flex flex-column justify-content-start pe-lg-3 pe-0">
                  <h3 className="title-heading">Our Tech Stack</h3>
                </div>
              </div>
              <div className="col">
                <div className="d-flex flex-column ps-lg-3 ps-0">
                  <p>
                    We build modern web and mobile applications using proven
                    technologies focused on performance, scalability, and long-term
                    maintainability.
                  </p>
                </div>
              </div>
