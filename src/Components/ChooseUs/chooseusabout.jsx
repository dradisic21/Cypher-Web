              ...
              <div className="d-flex flex-column gspace-5">
                <AnimateOnScroll animation="fadeInDown" speed="normal">
                  <div className="d-flex flex-column gspace-2">
                    ...
                    <p className="mb-0">
                      In a digital landscape that changes constantly, results
                      matter more than promises. At Marko, we focus on clear
                      strategy, smart execution, and measurable outcomes that
                      help brands grow sustainably.
                    </p>
                  </div>
                </AnimateOnScroll>
                      ...
                      <div className="card-chooseus-cta-wrapper">
                        <AnimateOnScroll animation="fadeInUp" speed="normal">
                          <div className="card card-chooseus-cta">
                            <h5>
                              Partner with Cypher & take your brand to the next
                              level.
                            </h5>
